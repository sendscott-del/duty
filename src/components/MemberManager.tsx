    ...
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-purple-600 hover:bg-purple-50 rounded-lg"
        >
      ...
      {showAdd && (
        <form onSubmit={handleAddChild} className="mt-4 p-4 bg-purple-50 rounded-xl space-y-3">
          <div>
              ...
              {AVATARS.map(a => (
                <button
                  ...
                  className={`w-10 h-10 rounded-lg text-xl flex items-center justify-center ${
                    emoji === a ? 'bg-purple-200 ring-2 ring-purple-500' : 'bg-white hover:bg-gray-100'
                  }`}
                >
                  {a}
                </button>
